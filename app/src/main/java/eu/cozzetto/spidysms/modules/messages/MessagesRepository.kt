...
import eu.cozzetto.spidysms.data.entities.MessageType
import eu.cozzetto.spidysms.data.entities.MessageWithRecipients
import eu.cozzetto.spidysms.data.entities.MessagesTotals
...
class MessagesRepository(private val dao: MessagesDao) {
    ...
    private fun MessageWithRecipients.toRequest(): StoredSendRequest {
        ...
        return StoredSendRequest(
            ...
            eu.cozzetto.spidysms.modules.messages.data.Message(
