...
import io.ktor.server.routing.route
import eu.cozzetto.spidysms.data.entities.MessageWithRecipients
import eu.cozzetto.spidysms.domain.EntitySource
import eu.cozzetto.spidysms.domain.MessageContent
...
import eu.cozzetto.spidysms.modules.localserver.domain.InboxRefreshRequest
import eu.cozzetto.spidysms.modules.localserver.domain.messages.DataMessage
import eu.cozzetto.spidysms.modules.localserver.domain.messages.PostMessageRequest
import eu.cozzetto.spidysms.modules.localserver.domain.messages.TextMessage
import eu.cozzetto.spidysms.modules.messages.MessagesService
import eu.cozzetto.spidysms.modules.messages.data.Message
import eu.cozzetto.spidysms.modules.messages.data.SendParams
import eu.cozzetto.spidysms.modules.messages.data.SendRequest
import eu.cozzetto.spidysms.modules.messages.exceptions.ConflictException
...
class MessagesRoutes(
    ...
    ): eu.cozzetto.spidysms.modules.localserver.domain.messages.Message {
        return eu.cozzetto.spidysms.modules.localserver.domain.messages.Message(
            id = message.id,
            deviceId = deviceId,
            state = message.state,
            isHashed = false,
            ...
            recipients = recipients.map {
                eu.cozzetto.spidysms.modules.localserver.domain.messages.Message.Recipient(
                    it.phoneNumber,
                    it.state,
                    it.error
                )
