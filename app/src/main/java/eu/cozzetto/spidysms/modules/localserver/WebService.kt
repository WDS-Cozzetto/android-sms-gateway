package eu.cozzetto.spidysms.modules.localserver
...
import eu.cozzetto.spidysms.modules.localserver.auth.JwtService
import eu.cozzetto.spidysms.modules.localserver.auth.requireScope
import eu.cozzetto.spidysms.modules.localserver.domain.Device
import eu.cozzetto.spidysms.modules.localserver.routes.AuthRoutes
import eu.cozzetto.spidysms.modules.localserver.routes.DocsRoutes
import eu.cozzetto.spidysms.modules.localserver.routes.InboxRoutes
import eu.cozzetto.spidysms.modules.localserver.routes.LogsRoutes
import eu.cozzetto.spidysms.modules.localserver.routes.MessagesRoutes
import eu.cozzetto.spidysms.modules.localserver.routes.WebhooksRoutes
import eu.cozzetto.spidysms.modules.notifications.NotificationsService
    ...
    private val server by lazy {
        embeddedServer(
            ...
            install(ContentNegotiation) {
                gson {
                    if (eu.cozzetto.spidysms.BuildConfig.DEBUG) {
                        setPrettyPrinting()
                    }
                    configure()
                }
            ...
            routing {
                ...
                authenticate("auth-basic", "auth-jwt") {
                    ...
                    route("/settings") {
                        eu.cozzetto.spidysms.modules.localserver.routes.SettingsRoutes(get())
                            .register(this)
                    }
                    route("/docs") {
